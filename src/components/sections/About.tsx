      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          <p className="text-lg md:text-2xl text-white/70 leading-relaxed">
            A self-taught frontend developer with a passion for building clean,
            interactive web experiences. Over the past two years I&apos;ve been
            learning independently — going from zero to shipping real projects
            using React, Next.js, and Tailwind CSS. I care deeply about design
            details, smooth interactions, and writing code that&apos;s easy to
            read and maintain.
          </p>
        </motion.div>
